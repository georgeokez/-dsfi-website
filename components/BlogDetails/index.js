                        ...
                        <div className="wpo-wpo-blog-content clearfix">
                            <div className="post">
                                <div className="entry-media">
                                    <img src='images/blog/counseling_n_support_big.png' alt=""/>
                                </div>
                                <ul className="entry-meta">
                                    <li><Link href="/BlogDetails"><a><img src='images/blog-details/author-pic-angel_smaller.png' alt=""/>  By Angel Akinwale</a></Link></li>
                                    <li><Link href="/BlogDetails"><a><i className="ti-calendar"></i> Jan 25,2022</a></Link></li>
                                ...
                                <blockquote>The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. </blockquote>
                                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now.</p>
                                <p>The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages and web page editors now.</p>
                            </div>
                            ...
                            <div className="author-box">
                                <div className="author-avatar">
                                    <Link href="/BlogDetails" target="_blank"><a><img src='images/blog-details/author-pic-angel.png' alt=""/></a></Link>
                                </div>
                                <div className="author-content">
                                    <Link href="/BlogDetails" ><a className="author-name">Angel Akinwale</a></Link>
                                    <p>Angel Akinwale is a business consultant, with over 20 years of business management experience (both government and private sectors).</p>
