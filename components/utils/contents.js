export const missionStatement =
  "Serving the community with Faith, Hope and Love. Philippians 4:13 - I can do all things through Christ who strengthens me.";
...
export const addon3 = {
  content3a:
    "We will provide case management, advisory, counseling, enrichment services and programs that will assist individuals and families in discovering the root cause of their challenge(s). Through strategies and Enrichment Programs offered within DSF, Inc., (Maryland and Washington, D.C.) individuals and families will be able to…",
  content3b:
    "Therapy will be required for all individuals and families through in-house counseling/advisory, and psychiatrists/psychologists will be recommended as needed.",
...
export const addon4 = {
  ...
  content4Items: [
    ...
    "Healing & Positive Transformation",
...
export const volunteerContext = {
  ...
  paragraphTwo:
    "If you are interested in becoming a volunteer with DSF, Inc., please kindly fill out this form:  ",
  mentorParagraphFooter:
    "If you are interested in becoming an intern with DSF, Inc., please email your resume to info.DSF, Inc.nc@gmail.com and include the position you wish to apply for in the subject line. ",
  formLink:
    "https://docs.google.com/forms/d/e/1FAIpQLScHusQypQlN6kt6nlmFLYOAmkKtqle7HvAiU9-iGNnyJZGP3w/viewform",
};
...
export const contactDetials = {
  ...
  phone: "301-597-8367",
  fax: "(240) 414-4794",
  mailing: "8507 Oxon Hill Rd Ste 200 #1031 Fort Washington, MD 20744",
};
...
export const socialMediaLinks = {
  ...
  linkedIn:
    "https://www.linkedin.com/in/divine-services-foundations-inc-3224b8252/",
};

export const paymentLink =
  "https://www.paypal.com/donate/?hosted_button_id=BDJJK4PD94UJ8";
