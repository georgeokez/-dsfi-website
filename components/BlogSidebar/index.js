        ...
        <div className="col col-lg-4 col-sm-12 col-12">
            <div className="wpo-blog-sidebar">
                ...
                <div className="widget category-widget">
                    <h3>Categories</h3>
                    <ul>
                        <li><Link href="/BlogDetails">Self Esteem</Link></li>
                        <li><Link href="/BlogDetails">Housing Problems</Link></li>
                        <li><Link href="/BlogDetails">Self Love</Link></li>
                        <li><Link href="/BlogDetails">Legal Assistance</Link></li>
                        <li><Link href="/BlogDetails">Building Confidence</Link></li>
                    </ul>
                </div>
